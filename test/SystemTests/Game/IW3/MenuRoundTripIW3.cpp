...
namespace
{
    TEST_CASE("Menu loading and dumping (IW3)", "[iw3][menu][system]")
    {
        ...
        // Members get a file each and the list references them. Inlining them all into the list instead would blow
        // linker_pc's 32768 byte limit on a menu file for any list the size of a stock one.
